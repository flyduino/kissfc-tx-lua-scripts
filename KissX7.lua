...
SetupPages = {
   {
      ...
      fields = {
         ...
         { x = 47,  y = 25, i=2, max=65000, prec=3 },
         { x = 75, y = 25, i=3, max=65000, prec=2 },
         -- I
         { x = 20,  y = 38, i=4, max=65000, prec=2 },
         { x = 47, y = 38, i=5, max=65000, prec=3 },
         { x = 75, y = 38, i=6, max=65000, prec=2 },
         -- D
         { x = 20,  y = 50, i=7, max=65000, prec=2 },
         { x = 47,  y = 50, i=8, max=65000, prec=3 },
         { x = 75, y = 50, i=9, max=65000, prec=2 }
      },
      read  = KISS_GET_PIDS,
      write = KISS_SET_PIDS,
   ...
   },
   {
      ...
      fields = {
         ...
         { x = 15,  y = 50,  i=7, min=1, max=7, table = { "Off", "High", "Med. High", "Medium", "Med. Low", "Low", "Very Low" } },
         { x = 82, y = 50,  i=8, min=0, max=97},
      },
   ...
   },
   {
      ...
      fields = {
         ...
         { t = "mAH",     x = 15, y = 45, sp = 30, i=2, min=0, max=26000, inc=10 }
      },
